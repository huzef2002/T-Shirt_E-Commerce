                        ...
                        <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-3 py-2 text-white bg-white/15 border-orange-700 focus:ring-1 focus:ring-orange-700 focus:outline-none"
                                />
                            </div>
                            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-orange-700 hover:bg-orange-600">
                                Subscribe
                            </button>
                        </form>
                    </div>
